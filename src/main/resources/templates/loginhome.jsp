    ...
    <svg viewBox="0 0 46 16" height="10" width="30" xmlns="http://www.w3.org/2000/svg" id="arrow-horizontal">
        <path transform="translate(30)" d="M8,0,6.545,1.455l5.506,5.506H-30V9.039H12.052L6.545,14.545,8,16l8-8Z" data-name="Path 10" id="Path_10"></path>
                ...
                <li class="categories-dropdown">
                    <a href="/loginpopup">Categories</a>
                    <div class="categories-dropdown-content">
                        <a href="/loginpopup">Electronics</a>
                        <a href="/loginpopup">Clothing</a>
                        <a href="/loginpopup">Books</a>
                        <a href="/loginpopup">Home & Garden</a>
                        <a href="/loginpopup">Toys & Games</a>
                        <!-- Add more categories as needed -->
                    </div>
                </li>
                <li><a href="/loginpopup">Products</a></li>
                <li><a href="/loginpopup">Contact Us</a></li>
